...
import { Eye, EyeOff, Mail, Lock, User, Sparkles, Globe } from 'lucide-react';
  ...
  const handleGoogle = useGoogleLogin({
    onSuccess: async (res) => {
      try {
        ...
        setWelcomeUser({ name: profile.name, avatarUrl: profile.picture, email: profile.email });
      } catch {
    ...
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center p-4">
        ...
        {welcomeUser && (
          ...
          >
            ...
            >
              ...
              <p className="text-xs font-bold uppercase tracking-widest text-[var(--primary)] mb-1">Account Created</p>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--muted)] mt-1">Start learning English today</p>
        </div>
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-lg p-8 space-y-5">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-[var(--muted)]">Name</label>
          ...
          <p className="text-center text-xs text-[var(--muted)]">
            ...
            <a href="/login" className="text-[var(--primary)] font-semibold hover:underline">Sign in</a>
          </p>
        </div>
      </motion.div>
    </div>
